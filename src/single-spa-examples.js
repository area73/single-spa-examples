...
// declareChildApplication('angular5', () => import('../build/ng5/main.bundle.js'), hashPrefix('/angular5'));
declareChildApplication('angular5', () => import('./angular5/angular5.app.js'), hashPrefix('/angular5'));
